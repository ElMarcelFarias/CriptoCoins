...
class CoinsListWorker: ListCoinsDataProviderDelegate {
    ...
    func doFetchListCoins(baseCoin: String, orderBy: String, top: Int, percentagePrice: String,
